import{s as E,g as p,a as R,r as g,b as O,e as v,c as m}from"./common-BSgaey2d.js";import{N as S,a as d}from"./navigate-CNMaaciz.js";import"./preview-errors-BMTnjymN.js";import"./index-DrFu-skq.js";import"./iframe-BcxLbnxy.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const L={title:"Synthetic/Navigate",argTypes:{...d,navigateToTarget:{name:"Navigate To",control:{type:"radio",labels:{0:"None",1:"Class",2:"Class's property",3:"Group",4:"Group's property",5:"Relation",6:"Non-existent"}},options:[0,1,2,3,4,5,6]}},args:{navigateToTarget:0,...S}},o="1",r=p(o+"lpg"),i=p(o+"lp"),c=R(o+"pg",{properties:[r]}),A=[...g(2,25).map(e=>R(e+"pg"))],T=O(o+"c",{properties:[c,i,...A]}),_=[...g(2,6).map(e=>O(e+"c",{properties:[p(e+"lp")]}))],C=[...g(1,6).map(e=>v({leafPropertyKey:`${e}lp`,referenceClassKey:`${e+1}c`}))],n=m({classes:[T,..._],relations:[...C]}),N=O("non-existent"),s=E((e,t)=>{const a={insets:e.navigateOptionInsets};switch(t.animationDuration=e.navigateOptionAnimationDuration,t.content=n,e.navigateToTarget){case 1:t.selectedObjects=[T],t.navigateTo([T],a);break;case 2:t.selectedObjects=[i],t.navigateTo([i],a);break;case 3:t.selectedObjects=[c],t.navigateTo([c],a);break;case 4:t.selectedObjects=[r],t.navigateTo([r],a);break;case 5:t.selectedObjects=[n.relations[0]],t.navigateTo([n.relations[0]],a);break;case 6:t.selectedObjects=[N],t.navigateTo([N],a);break;default:case 0:}},e=>(e.component.content=n,e));var l,P,b;s.parameters={...s.parameters,docs:{...(l=s.parameters)==null?void 0:l.docs,source:{originalSource:`storyArgsFunc((args, component) => {
