import { HasDeprecation, HasIdentity, HasName, HasPropertyKind, HasPropertyType, HasPropertyTypeDeprecation, HasRequired, PROPERTY_TYPE_LEAF } from '../../../../domain/object/base';
