import { HasGraphItemKey, LayoutGraphMeta } from '../../../../graph/common/layout-graph-definition';
import { GraphItem } from '../../../../graph/common/graph-definition';
import { SvgResourceDefiner, SvgResourceReader } from '../../../../graph/common/svg-resource-manager';
