...
export interface GraphMergerSession<Meta extends GraphMeta> {
    node<UserObject, Node extends Meta['node']>(userObject: UserObject, key: Meta['key'], modificationAppliers?: Optional<ModificationAppliers<Meta['graph'], Node, UserObject>>): void;
    port<UserObject, Port extends Meta['port']>(userObject: UserObject, key: Meta['key'], ownerKey: Meta['key'], modificationAppliers?: Optional<ModificationAppliers<Meta['graph'], Port, UserObject>>): void;
    edge<UserObject, Edge extends Meta['edge']>(userObject: UserObject, key: Meta['key'], sourceKey: Meta['key'], targetKey: Meta['key'], modificationAppliers?: Optional<ModificationAppliers<Meta['graph'], Edge, UserObject>>): void;
    label<UserObject, Label extends Meta['label']>(userObject: UserObject, key: Meta['key'], ownerKey: Meta['key'], labelText: string, modificationAppliers?: Optional<ModificationAppliers<Meta['graph'], Label, UserObject>>): void;
...
export type CreateApplier<Graph, Item, UserObject> = (graph: Graph, item: Item, userObject: UserObject) => void;
export type RemoveApplier<Graph, Item, UserObject> = (graph: Graph, item: Item, userObject: UserObject) => void;
export type UpdateApplier<Graph, Item, UserObject> = (graph: Graph, item: Item, newUserObject: UserObject, oldUserObject: UserObject) => void;
export declare function compositeModificationAppliers<Graph, Item, UserObject>(...appliers: ModificationAppliers<Graph, Item, UserObject>[]): ModificationAppliers<Graph, Item, UserObject>;
