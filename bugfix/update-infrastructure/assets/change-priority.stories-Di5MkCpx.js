import{D as h,s as v,i as f,r as s,b as d,g as _,L as c,C as g,e as D}from"./common-BSgaey2d.js";import"./preview-errors-BMTnjymN.js";import"./index-DrFu-skq.js";import"./iframe-BcxLbnxy.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const{useArgs:T}=__STORYBOOK_MODULE_CLIENT_API__;let i;const I={title:"Synthetic/Viewport",argTypes:{activateZoomChange:{name:"Activate zoom change",control:"boolean"},activateContentChange:{name:"Activate content change",control:"boolean"},activateNavigateChange:{name:"Activate navigate change",control:"boolean"},animationDuration:{name:"Animation duration",control:{type:"number",min:0,max:5e3,step:50}},action:{name:"Do action",control:{type:"radio",labels:{0:"None",1:"Action"}},options:[0,1]}},args:{animationDuration:h,activateZoomChange:!1,activateContentChange:!1,activateNavigateChange:!1,action:0}};function m(t){let n=[],e=[];for(let a=0;a<=10;a++){const l=[...s(1,10).map(o=>d(t+a+o+g,{properties:[_(t+a+o+c)]}))],A=[...s(1,10).map(o=>D({leafPropertyKey:t+a+o+c,referenceClassKey:`${t}${a+1}${o}${g}`}))];n=[...n,...l],e=[...e,...A]}return{classes:n,relations:e}}const r=v((t,n)=>{const[,e]=T();i=e,t.action==1&&(n.animationDuration=t.animationDuration,t.activateZoomChange&&(n.zoom=.5),t.activateContentChange&&(n.content=m(Math.random().toString())),t.activateNavigateChange&&n.navigateTo([n.content.classes[0]]),setTimeout(()=>{f(i)&&i({action:0})},1))},t=>(t.component.content=m(Math.random().toString()),t));var p,C,u;r.parameters={...r.parameters,docs:{...(p=r.parameters)==null?void 0:p.docs,source:{originalSource:`storyArgsFunc((args, component) => {
